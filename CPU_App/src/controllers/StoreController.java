...
public class StoreController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		if(!user.equals("")){
			boolean[] dpload = UserDatabase.getUserData(user).getDPSTORE();
			int count = UserDatabase.getCount(UserDatabase.getUserData(user).getDPSTORE());
	...
	public void setLines(){
		if( (checkButton.getId().equals("tb1") && btn.getId().equals("tb2")) ||
			...
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPSTORE(1);
		}
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPSTORE(2);
		}
		//Mux
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPSTORE(4);
		}
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPSTORE(5);
		}
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPSTORE(6);
		}
		//mux
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPSTORE(9);
		}
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPSTORE(11);
		}
		//mux
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPSTORE(13);
		}
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPSTORE(14);
		}
		//mux
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPSTORE(15);
		}
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPSTORE(17);
		}
		else{
