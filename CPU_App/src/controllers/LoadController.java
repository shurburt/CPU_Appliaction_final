...
public class LoadController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		if(!user.equals("")){
			dpload = UserDatabase.getUserData(user).getDPLOAD();
			int count = UserDatabase.getCount(UserDatabase.getUserData(user).getDPLOAD());
	...
	public void setLines(){
		if( (checkButton.getId().equals("tb1") && btn.getId().equals("tb2")) ||
			...
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPLOAD(1);
		}
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPLOAD(2);
		}
		//Mux
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPLOAD(3);
		}
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPLOAD(5);
		}
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPLOAD(6);
		}
		//mux
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPSTORE(8);
		}
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPLOAD(9);
		}
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPLOAD(11);
		}
		//mux
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPLOAD(13);
		}
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPLOAD(14);
		}
		//mux
		else if(( checkButton.getId().equals("tb20") && btn.getId().equals("tb21")) ||
				( btn.getId().equals("tb20")) && checkButton.getId().equals("tb22")  ){
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPLOAD(15);
			...
			changeFeedback(true);changeInstCount();
			if(!user.equals(""))
			UserDatabase.getUserData(user).setDPLOAD(17);
		}
		else{
	...
	public void initializeLine(int i){
