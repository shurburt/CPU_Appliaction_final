...
public class AnimAddController implements Initializable {

    @FXML
    private Polyline testPath0, testPath1, testPath3, testPath9, testPath13, testPath23;
    @FXML
    private Polyline testPath10, testPath5, testPath4, testPath21, testPath18, testPath20 , testPath22;

    @FXML
    private Line testPath2, testPath11, testPath7, testPath12, testPath17, testPath24, testPath14;
    @FXML
    private Line testPath16, testPath15, testPath6, testPath19, testPath8;
    ...
    @FXML
    private Circle circle22, circle23, circle24;
    @FXML
    private Button btn;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        add = new AnimateAdd(circles, lines);
